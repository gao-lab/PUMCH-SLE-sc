...
ht1 <- netAnalysis_signalingRole_heatmap(group_list[[1]], pattern = "outgoing", signaling = pathway.union,
        title = names(group_list)[1], width = 5, height = 6)
ht2 <- netAnalysis_signalingRole_heatmap(group_list[[2]], pattern = "outgoing", signaling = pathway.union,
        title = names(group_list)[2], width = 5, height = 6)
ht3 <- netAnalysis_signalingRole_heatmap(group_list[[3]], pattern = "outgoing", signaling = pathway.union,
        title = names(group_list)[3], width = 5, height = 6)
draw(ht1 + ht2 + ht3, ht_gap = unit(0.5, "cm"))

ht1 <- netAnalysis_signalingRole_heatmap(group_list[[1]], pattern = "incoming", signaling = pathway.union,
        title = names(group_list)[1], width = 5, height = 6)
ht2 <- netAnalysis_signalingRole_heatmap(group_list[[2]], pattern = "incoming", signaling = pathway.union,
        title = names(group_list)[2], width = 5, height = 6)
ht3 <- netAnalysis_signalingRole_heatmap(group_list[[3]], pattern = "incoming", signaling = pathway.union,
        title = names(group_list)[3], width = 5, height = 6)
